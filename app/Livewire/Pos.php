...
class Pos extends Component implements HasForms
{
    ...
    /**
     * Processes the checkout operation by validating the customer details
     * and payment method, creating an order record with associated order
     * products, clearing the current order items, and redirecting to the
     * orders page.
     *
     * Validates:
     * - Customer name (required, string, max 255 characters)
     * - Gender (required, must be 'male' or 'female')
     * - Payment method ID (required)
     *
     * Creates:
     * - An Order record with customer details, total price, and payment method
     * - OrderProduct records for each item in the order with quantity and unit price
     *
     * Resets:
     * - Clears the order items and session data for 'orderItems'
     *
     * Redirects to the orders administration page upon completion.
     */
